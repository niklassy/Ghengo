...
def test_assignment_statement_template():
    ...
    assert statement.to_template(5, True) == '     var_name = foo(bar=123)'
...
def test_pass_statement_template():
    ...
    assert statement.to_template(4, True) == '    pass'
...
def test_assert_statement_template():
    ...
    assert statement.to_template(4, True) == '    assert foo(bar=123)'
